...
const ProductTable = () => {
  ...
  React.useEffect(() => {
    ...
    fetchData();
    axios
      .get("https://8080-cdcaeebeddfbdcceabcedefcacfefaabeaeaadbdbabf.project.examly.io/locations")
      .then((response) => {
  ...
  React.useEffect(() => {
    if (bar !== "")
      axios
        .get(`https://8080-cdcaeebeddfbdcceabcedefcacfefaabeaeaadbdbabf.project.examly.io/pg?barcode=${bar}`)                   //barcode
  ...
  React.useEffect(() => {
    if (ids === "") {
      ...
      axios
        .post("https://8080-cdcaeebeddfbdcceabcedefcacfefaabeaeaadbdbabf.project.examly.io/inventory", j)
        .then((response2) => {
      ...
      axios
        .post("https://8080-cdcaeebeddfbdcceabcedefcacfefaabeaeaadbdbabf.project.examly.io/purchase-orderss", verdict)
  ...
  const handleAddProduct = () => {
    ...
    axios
      .post("https://8080-cdcaeebeddfbdcceabcedefcacfefaabeaeaadbdbabf.project.examly.io/barcode-scanners", bars)
      .then((res) => console.log(res))
      .catch((err) => console.log(err));
  };

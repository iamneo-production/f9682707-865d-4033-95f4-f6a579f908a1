...
const ProductTable = () => {
  ...
  const fetchData = () => {
    axios
      .get("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/products")
  ...
  React.useEffect(() => {
    ...
    fetchData();
    axios
      .get("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/locations")
      .then((response) => {
  ...
  React.useEffect(() => {
    if (bar !== "")
      axios
        .get(`https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/pg?barcode=${bar}`)                   //barcode
  ...
  React.useEffect(() => {
    if (ids === "") {
      ...
      axios
        .post("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/inventory", j)
        .then((response2) => {
      ...
      axios
        .post("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/purchase-orderss", verdict)
  ...
  const editProduct = () => {                                             //edit product
    ...
    console.log(jsosn);
    axios
      .put("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/products", jsosn)
  ...
  const deleteProduct = (id) => {                                                   //delete product
    console.log(id);
    axios
      .delete("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/products", { params: { id } })
      .then(function (response) {
        console.log(response);
      })
      .catch(function (error) {
  ...
  const handleAddProduct = () => {
    ...
    axios
      .post("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/products", json)
      .then((res) => {
        setbar(barcode);
        setquan(quantity);
        setur(location);
    ...
    axios
      .post("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/barcode-scanners", bars)
      .then((res) => console.log(res))
      .catch((err) => console.log(err));
  };

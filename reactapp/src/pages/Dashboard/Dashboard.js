...
axios.post("https://8080-addccdfdabcedefcacfefaabebceecbecadec.project.examly.io/sales",json).then(function(response){setwar(response.data)}).catch(function(error){console.log(error)});
...
setTimeout(()=>{
  ...
  axios.post("https://8080-addccdfdabcedefcacfefaabebceecbecadec.project.examly.io/shipment",ones).then(function(response){console.log(response)}).catch(function(error){console.log(error)});
},10000)

...
const [inv,setinv]=useState([]);
  ...
  React.useEffect(() => {
    ...
    axios.get("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/product").then((response) => {
        setpros(response.data)}).catch(err=>console.log(err));

        axios.get("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/sales").then((response) => {
        setsell(response.data)}).catch(err=>console.log(err));

        
        axios.get("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/inventory").then((response) => {

...
const Home = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://8080-dddaeaedabcedefcacfefaabebceecbecadec.project.examly.io/locations')
      .then(res => res.json())
      .then(data => {
        setData(data);
      });
  ...
  const handleDelete = (id) => {
    ...
    axios.delete('https://8080-dddaeaedabcedefcacfefaabebceecbecadec.project.examly.io/locations',{params:{id}}).then(function(response){console.log(response)}).catch(function(error){console.log(error)});
  };
  const submit=()=>{
  ...
  axios.post("https://8080-dddaeaedabcedefcacfefaabebceecbecadec.project.examly.io/locations",json).then(function(response){console.log(response)}).catch(function(error){console.log(error)});
  }
  const store=()=>{
  ...
  let contact=document.getElementById("four").value;
   ...
   axios.put("https://8080-dddaeaedabcedefcacfefaabebceecbecadec.project.examly.io/locations",json).then(function(response){console.log(response)}).catch(function(error){console.log(error)});
  }
  return (

...
function Alerts() {
  ...
  useEffect(()=>{
    ...
    axios.get("https://8080-fcccdbdeacaabcedefcacfefaabeaeaadbdbabf.project.examly.io/productsless").then(response=>setalert(response.data)).catch(err=>console.log(err));
    axios.get("https://8080-fcccdbdeacaabcedefcacfefaabeaeaadbdbabf.project.examly.io/total").then(response=>settot(response.data)).catch(err=>console.log(err));
    axios.get("https://8080-fcccdbdeacaabcedefcacfefaabeaeaadbdbabf.project.examly.io/totalert").then(response=>settotalert(response.data)).catch(err=>console.log(err));
},)
...
const submits=()=>{
  ...
  axios.post("https://8080-fcccdbdeacaabcedefcacfefaabeaeaadbdbabf.project.examly.io/purchase-order",json).then(function(response){console.log(response)}).catch(function(error){console.log(error)});
  }
  return (
    <div>

...
const [sal,setsal]=useState([]);
    ...
    useEffect(()=>{
      if(!localStorage.getItem("auth")){
        ...
        axios.get("https://8080-cdcaeebeddfbdcceabcedefcacfefaabebceecbecadec.project.examly.io/sales").then(response=>setsal(response.data)).catch(err=>console.log(err));
    },)
    return (
        <div>
            <Frame />
